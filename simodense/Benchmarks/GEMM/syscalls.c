// Based on the examples from riscv-tools (https://github.com/riscv/riscv-tools) 
...
uint64_t time()
{
    uint32_t cycles_low, cycles_high, cycles_high1;
    asm volatile ("rdcycle %0" : "=r"(cycles_low));
    asm volatile ("rdcycleh %0" : "=r"(cycles_high));
    do {
        cycles_high1 = cycles_high;
        asm volatile ("rdcycle %0" : "=r"(cycles_low));
        asm volatile ("rdcycleh %0" : "=r"(cycles_high));
    } while (cycles_high1 != cycles_high);
