...
FLAGS="-DN=$1 -DTILE_SIZE=$2 -DTILED=$3"
...
sed -i "s/\`define StartAddress 32'h.*/\`define StartAddress $start_address/" ../../RTL_and_simulation/testbench.v
sed -i "s/\`define SymbolTable 32'h.*/\`define SymbolTable $symbol_table/" ../../RTL_and_simulation/testbench.v
